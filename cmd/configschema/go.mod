...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/asapauthextension v0.41.0 // indirect
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.309 // indirect
